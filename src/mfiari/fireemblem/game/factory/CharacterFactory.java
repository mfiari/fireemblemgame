...
import mfiari.fireemblem.game.behaviour.character.*;
import mfiari.fireemblem.game.behaviour.combat.*;
import mfiari.fireemblem.game.behaviour.move.*;
    ...
    public Character createCharacter(String nom, Organization organisation, CharacterType typePersonnage) {
        ...
        switch (typePersonnage) {
            ...
            case assassin_jaffart:
                ...
                return jaffart;
            case bandit:
                Character bandit = new Character(nom, organisation);
                bandit.setComportementPersonnage(new BanditBehaviour());
                bandit.setMoveBehaviour(new BanditMovement());
                bandit.setFightBehaviour(new BanditFightBehaviour());
                bandit.setPourcentagePv(85);
                bandit.setPourcentagePuissance(60);
                bandit.setPourcentageMagie(10);
                bandit.setPourcentageCapacite(30);
                bandit.setPourcentageVitesse(35);
                bandit.setPourcentageChance(20);
                bandit.setPourcentageDefense(25);
                bandit.setPourcentageResistance(16);
                return bandit;
            case berserker:
