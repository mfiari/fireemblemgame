...
public class ImageUtil extends Image {
    ...
    public BufferedImage getBindingBlade () {
        return this.getImage(ImageUtil.class.getResourceAsStream("/fireemblem/media/image/util/binding_blade.png"));
    }
    
    public BufferedImage getBlazingSword () {
        return this.getImage(ImageUtil.class.getResourceAsStream("/fireemblem/media/image/util/blazing_sword.png"));
    }
    
    public BufferedImage getPathOfRadiance () {
        return this.getImage(ImageUtil.class.getResourceAsStream("/fireemblem/media/image/util/path_of_radiance.jpg"));
    }
